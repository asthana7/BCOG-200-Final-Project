...
def main():
    ...
    while True:
        ...
        latest_coords['Left'] = None
        latest_coords['Right'] = None
        #  ####################################################################
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                #my addition --> which hand
                label = handedness.classification[0].label
                # Landmark calculation
                landmark_list = calc_landmark_list(debug_image, hand_landmarks)
                #BRO THIS LINE ABOVE IS THE ANSWER TO ALL YOUR PROBLEMS
                thumb_x, thumb_y = landmark_list[4][0], landmark_list[4][1]
                index_x, index_y = landmark_list[8][0], landmark_list[8][1]
                thumb_coord = [thumb_x, thumb_y]
                index_coord = [index_x, index_y]

                latest_coords[label] = (thumb_coord, index_coord)
                #element no. of thumb end = 4-> so if you do landmark_list[0], you'll get [x,y] of thumb end
                #element no. of index end = 8
    ...
    #return thumb_coord, index_coord
